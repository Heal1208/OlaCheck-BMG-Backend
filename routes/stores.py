...
# ---------------------------------------------------------------
# A-05: View Assigned Stores
# GET /api/stores/assigned
# - Sales_Executive / Sales_Admin : chỉ thấy stores được giao
# - Sales_Manager / Director      : thấy tất cả stores
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# A-06: Store Lookup
# GET /api/stores/search?q=<keyword>&district=&city=&store_type=
# ---------------------------------------------------------------
...
def search_stores(current_user):
    ...
    if not any([keyword, district, city, store_type]):
        return jsonify({
            "success": False,
            "message": "Vui lòng nhập ít nhất 1 tiêu chí tìm kiếm"
        }), 400
...
# ---------------------------------------------------------------
# GET /api/stores/<store_id>  — chi tiết 1 cửa hàng
# ---------------------------------------------------------------
